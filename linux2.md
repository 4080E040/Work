...
eth0: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        ...
        RX packets 12471  bytes 856804 (836.7 KiB)
        RX errors 0  dropped 0  overruns 0  frame 0
        TX packets 51  bytes 5811 (5.6 KiB)
...
lo: flags=73<UP,LOOPBACK,RUNNING>  mtu 65536
        ...
        RX packets 847  bytes 553630 (540.6 KiB)
        RX errors 0  dropped 0  overruns 0  frame 0
        TX packets 847  bytes 553630 (540.6 KiB)
        TX errors 0  dropped 0 overruns 0  carrier 0  collisions 0
```
```有3個介面(interfaces):
[1]docker 0
...
問題3.MAC address==實體網卡位址==>ether 08:00:27:06:39:1d
問題4.broadcast address==172.20.164.255
